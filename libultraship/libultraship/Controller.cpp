...
namespace Ship {
	...
	void Controller::LoadBinding() {
		...
		ButtonMapping[Ship::stoi(Conf[ConfSection][STR(BTN_CRIGHT_2)])] = BTN_CRIGHT;
		ButtonMapping[Ship::stoi(Conf[ConfSection][STR(BTN_CLEFT_2)])] = BTN_CLEFT;
		ButtonMapping[Ship::stoi(Conf[ConfSection][STR(BTN_CDOWN_2)])] = BTN_CDOWN;
		ButtonMapping[Ship::stoi(Conf[ConfSection][STR(BTN_CUP_2)])] = BTN_CUP;
